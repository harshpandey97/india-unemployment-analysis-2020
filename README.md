...
National Trend Unemployment rate spiked sharply in April–May 2020 following the nationwide lockdown, before gradually recovering through Q3–Q4.

2. State-wise Unemployment Comparison
State Comparison Haryana and Tripura recorded the highest average unemployment rates, while Meghalaya, Assam, and Gujarat remained relatively stable.

3. Zone-wise Unemployment Comparison
Zone Comparison The North zone was hit hardest on average, while the West zone showed the fastest recovery trajectory.

4. Correlation: Labour Participation Rate vs Unemployment Rate
Correlation Weak correlation (-0.07) indicates the unemployment spike was driven by forced closures (supply shock), not a drop in workforce participation.

5. State-wise Unemployment Heatmap
Heatmap Heatmap visualization highlighting the intensity and spread of unemployment across states over the 11-month period.
